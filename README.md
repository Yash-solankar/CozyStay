...
CozyStay is a full-stack travel accommodation platform that allows users to discover destinations, create property listings, upload images, view locations on interactive maps, and share reviews.
...
```bash
git clone https://github.com/Yash-solankar/CozyStay.git
cd CozyStay
npm install
```
...
🔗 https://cozystay-7gz0.onrender.com/listings

---

## GitHub Repository

🔗 https://github.com/Yash-solankar/CozyStay
